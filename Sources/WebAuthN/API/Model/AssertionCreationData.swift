 ...
 */
public struct AssertionCreationData {
    public let credentialIDResult: [UInt8]
    public let clientDataJSONResult: Data
    public let authenticatorDataResult: Data
    public let signatureResult: Data
    public let userHandleResult: [UInt8]?
